...
User.find(2).user_image.attach(io: File.open(Rails.root.join('app/assets/images/boy_01.png')),filename: 'boy_01.png')
User.find(3).user_image.attach(io: File.open(Rails.root.join('app/assets/images/boy_02.png')),filename: 'boy_02.png')
User.find(4).user_image.attach(io: File.open(Rails.root.join('app/assets/images/boy_03.png')),filename: 'boy_03.png')
User.find(5).user_image.attach(io: File.open(Rails.root.join('app/assets/images/girl_13.png')),filename: 'girl_13.png')
User.find(6).user_image.attach(io: File.open(Rails.root.join('app/assets/images/girl_14.png')),filename: 'girl_14.png')
User.find(7).user_image.attach(io: File.open(Rails.root.join('app/assets/images/girl_15.png')),filename: 'girl_15.png')
User.find(8).user_image.attach(io: File.open(Rails.root.join('app/assets/images/animal_inu.png')),filename: 'animal_inu.png')
User.find(9).user_image.attach(io: File.open(Rails.root.join('app/assets/images/animal_neko.png')),filename: 'animal_neko.png')
User.find(10).user_image.attach(io: File.open(Rails.root.join('app/assets/images/animal_penguin.png')),filename: 'animal_penguin.png')
User.find(11).user_image.attach(io: File.open(Rails.root.join('app/assets/images/youngman_25.png')),filename: 'youngman_25.png')
User.find(12).user_image.attach(io: File.open(Rails.root.join('app/assets/images/youngwoman_37.png')),filename: 'youngwoman_37.png')